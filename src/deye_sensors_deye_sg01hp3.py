...
deye_sg01hp3_grid_charge_128 = SingleRegisterSensor(
    ...
    128,
    1,
    mqtt_topic_suffix="gridcharge/ampere",
    unit="A",
    signed=False,
    groups=["deye_sg01hp3_gridcharge"],
)
...
deye_sg01hp3_register_ranges = [
    ...
    SensorRegisterRange(group="deye_sg01hp3_gridcharge", first_reg_address=128, last_reg_address=128),
]
